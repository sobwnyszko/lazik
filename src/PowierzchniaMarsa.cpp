...
{
  for (double WspY = -ROMIAR_POWIERZCHNI_Y/2;WspY <= ROMIAR_POWIERZCHNI_Y/2;WspY += ROZMIAR_OCZKA_KRATY) {

     for (double WspX = -ROMIAR_POWIERZCHNI_X/2;WspX <= ROMIAR_POWIERZCHNI_X/2;WspX += ROZMIAR_OCZKA_KRATY) {
